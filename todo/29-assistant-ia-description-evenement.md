# 29. Assistant IA pour la description d'événement

Objectif : accompagner les animateurs dans la rédaction des descriptions d'événements en proposant un bouton d'assistance IA directement intégré au formulaire d'édition.
...
- [ ] Ajouter un module JS dédié (`js/admin/event-ai-helper.js`) chargé via `core/assets.php` uniquement sur l'écran d'édition d'événement (`mj_member_admin_enqueue_event_assets`).
