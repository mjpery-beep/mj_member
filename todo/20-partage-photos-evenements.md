...
- [x] Permettre la suppression ou le masquage rapide d'une photo deja publiee.
...
- [x] Y afficher la liste des evenements passes auxquels le jeune etait present avec acces rapide a l'upload et a la galerie correspondante.
