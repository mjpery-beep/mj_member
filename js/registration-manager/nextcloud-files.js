...
(function (global) {
    ...
    function MediaTab(props) {
        ...
        return h('div', { class: 'mj-nc-media-tab' }, [
            ...
            !loading && sorted.length === 0 && h('div', { class: 'mj-nc-empty' }, [
                h('span', null, isPhotos ? '📸 Aucune photo.' : '📁 Aucun document.'),
            ]),

            !loading && isPhotos && sorted.length > 0 && h('div', { class: 'mj-nc-photo-grid' },
            ...
            !loading && !isPhotos && sorted.length > 0 && h('div', { class: 'mj-nc-doc-list' },
                sorted.map(function (item) {
