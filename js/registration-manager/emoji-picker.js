...
(function (global) {
    ...
    // Shared Preact component reused by widgets needing the emoji picker UI.
    ...
    if (typeof global.dispatchEvent === 'function') {
        try {
            ...
            if (typeof CustomEvent === 'function') {
                readyEvent = new CustomEvent('mj-regmgr-emoji-picker-ready', { detail: readyDetail });
            } else if (global.document && typeof global.document.createEvent === 'function') {
                readyEvent = global.document.createEvent('CustomEvent');
                readyEvent.initCustomEvent('mj-regmgr-emoji-picker-ready', false, false, readyDetail);
            }
            if (readyEvent) {
                global.dispatchEvent(readyEvent);
            }
        } catch (readyError) {
            // Silently ignore notification issues
        }
    }
