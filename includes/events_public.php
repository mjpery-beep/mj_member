    ...
    function mj_member_ensure_events_widget_localized() {
        ...
        wp_localize_script(
            ...
            array(
                ...
                'registrationUrl' => esc_url_raw(function_exists('mj_member_login_component_get_registration_url') ? mj_member_login_component_get_registration_url() : home_url('/inscription')),
                'strings' => array(
                    ...
                    'loginRequired' => __('Connecte-toi pour t\'inscrire à cet événement.', 'mj-member'),
                    'loginButtonLabel' => __('Se connecter', 'mj-member'),
                    'fieldRequired' => __('Tous les champs sont obligatoires.', 'mj-member'),
                    'loginError' => __('Identifiants incorrects.', 'mj-member'),
                    'loginSuccess' => __('Connexion réussie. Rechargement...', 'mj-member'),
                    'signupButtonLabel' => __('Devenir membre', 'mj-member'),
