...
class Mj_Member_Elementor_Dock_Tabs_Widget extends Widget_Nested_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .mj-dock-tabs__panel' => 'background: {{VALUE}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label' => __('Fond onglet actif', 'mj-member'),
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            'tab_active_outline',
            array(
                'label' => __('Halo onglet actif', 'mj-member'),
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .mj-dock-tabs__tab.is-active' => 'box-shadow: 0 0 0 1px {{VALUE}}, 0 14px 30px rgba(15, 23, 42, 0.35);',
                ),
            )
        );
    ...
    protected function render()
    {
        ...
        echo '<div class="' . esc_attr(implode(' ', array_map('sanitize_html_class', $root_classes))) . '" data-mj-dock-tabs="1" data-default-index="' . esc_attr((string) $default_tab_index) . '" data-dock-position="' . esc_attr($dock_position) . '">';
