...
if (!function_exists('mj_member_get_elementor_widgets_map')) {
    function mj_member_get_elementor_widgets_map() {
        return array(
            ...
            'Mj_Member_Elementor_Photo_Import_Timeline_Widget' => 'includes/elementor/class-mj-member-photo-import-timeline-widget.php',
            ...
            'Mj_Member_Elementor_Request_Management_Widget' => 'includes/elementor/class-mj-member-request-management-widget.php',
            ...
            'Mj_Member_Elementor_Tactile_Keyboard_Widget' => 'includes/elementor/class-mj-member-tactile-keyboard-widget.php',
