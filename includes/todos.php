    ...
    function mj_member_todo_widget_localize(): void
    {
        ...
        $config = array(
            ...
            'actions' => array(
                ...
                'unarchive' => 'mj_member_todo_unarchive',
            ...
            'i18n' => array(
                ...
                'sessionExpired' => __('Session expirée. Merci de vous reconnecter.', 'mj-member'),
                'unexpectedResponse' => __('Réponse inattendue du serveur.', 'mj-member'),
                ...
                'unarchiveLabel' => __('Restaurer', 'mj-member'),
                'unarchivingLabel' => __('Restauration…', 'mj-member'),
                'emojiLabel' => __('Emoji', 'mj-member'),
                'emojiPlaceholder' => __('Ex : 🎯', 'mj-member'),
                'emojiHint' => __('Facultatif, affiché avec le titre.', 'mj-member'),
                'emojiPicker' => __('Choisir', 'mj-member'),
                'emojiPickerClose' => __('Fermer', 'mj-member'),
                'emojiClear' => __('Effacer', 'mj-member'),
                'emojiSuggestions' => __('Suggestions', 'mj-member'),
...
if (!function_exists('mj_member_todo_prepare_payload')) {
    ...
    function mj_member_todo_prepare_payload(array $todo, array $projectMap, int $viewerMemberId = 0): array
    {
        ...
        $emoji = isset($todo['emoji']) ? MjTodos::sanitize_emoji_value($todo['emoji']) : '';
