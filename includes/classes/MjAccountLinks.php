    ...
    public static function getDefaultSettings(): array {
        ...
        $default_links = array(
            ...
            'day_notes' => array(
                ...
                'description' => __('Créez et gérez les notes du calendrier.', 'mj-member'),
                'slug' => 'notes',
                'query' => array('section' => 'day_notes'),
                'enabled' => true,
                'page_id' => 0,
                'visibility' => 'staff',
                'editable_label' => true,
            ...
            'inventory' => array(
                'label' => __('Inventaire', 'mj-member'),
                'description' => __('Consultez et gérez le matériel de la maison de jeunes.', 'mj-member'),
                'slug' => 'inventaire',
                'query' => array('section' => 'inventory'),
                'enabled' => true,
                'page_id' => 0,
                'visibility' => 'staff',
                'editable_label' => true,
            ...
            'mileage' => array(
                ...
                'description' => __('Déclarez et suivez vos frais kilométriques.', 'mj-member'),
                'slug' => 'frais-kilometriques',
                'query' => array('section' => 'mileage'),
                'enabled' => true,
                'page_id' => 0,
                'visibility' => 'hours_team',
                'editable_label' => true,
