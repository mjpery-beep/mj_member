...
class MjEvents_List_Table extends WP_List_Table {
    ...
    public function column_actions($item) {
        ...
        $buttons = array();
        $buttons[] = '<a class="button button-small" href="' . esc_url($edit_url) . '">✏️ Éditer</a>';
        $buttons[] = '<a class="button button-small" href="' . esc_url($duplicate_url) . '">📄 Dupliquer</a>';
    ...
    public function process_bulk_action() {
        ...
        if (!$action || !in_array($action, array('activate', 'archive', 'duplicate'), true)) {
            return;
        }
