...
$config = array(
    ...
    'labels' => array(
        ...
        'previousDay' => __('Jour précédent', 'mj-member'),
        'nextDay' => __('Jour suivant', 'mj-member'),
        'showAllEvents' => __('Tous les événements', 'mj-member'),
        'showMyEvents' => __('Mes événements', 'mj-member'),
        ...
        'projectChooseAction' => __('Choisir dans la liste', 'mj-member'),
        'projectDrawerTitle' => __('Choisir un projet', 'mj-member'),
        'projectDrawerClose' => __('Fermer', 'mj-member'),
        'projectSearchLabel' => __('Rechercher un projet', 'mj-member'),
        'projectSearchPlaceholder' => __('Rechercher un projet…', 'mj-member'),
        'projectRecentLabel' => __('Récents', 'mj-member'),
        'projectEmptyOption' => __('Sans projet', 'mj-member'),
        ...
        'selectionDuplicate' => __('Dupliquer sur le créneau suivant', 'mj-member'),
        ...
        'selectionDuplicateNoSlot' => __('Aucun créneau disponible pour dupliquer cette plage sur cette journée.', 'mj-member'),
