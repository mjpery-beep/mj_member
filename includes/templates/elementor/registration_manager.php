...
$config_json = wp_json_encode(array(
    ...
    'strings' => array(
        ...
        'occurrenceGeneratorModeCustom' => __('Date unique', 'mj-member'),
        ...
        'occurrenceGenerationAddToGlobalSchedule' => __('Afficher sur la page Evenement', 'mj-member'),
        'occurrenceGenerationIncludeDatesInPreview' => __('Ajouter date début/fin dans l\'aperçu horaire', 'mj-member'),
        'occurrenceGenerationIncludeLocationInPreview' => __('Afficher le lieu dans l\'aperçu horaire', 'mj-member'),
        'occurrenceGenerationIncludeMembersInPreview' => __('Afficher les animateurs dans l\'aperçu horaire', 'mj-member'),
        'occurrenceGenerationRenameBatch' => __('Renommer', 'mj-member'),
        'occurrenceGenerationRenameBatchPrompt' => __('Titre du lot', 'mj-member'),
        'occurrenceGenerationBatchConfigTitle' => __('Configuration', 'mj-member'),
        'occurrenceGenerationSaveBatchConfig' => __('Enregistrer', 'mj-member'),
        'occurrenceGenerationAssignOccurrenceType' => __('Type d\'occurrence générée', 'mj-member'),
