        ...
        <form method="post" id="mj-settings-form" novalidate>
            ...
            <div class="mj-settings-tabs">
                <div class="mj-settings-tabs__nav" role="tablist">
                    ...
                    <button type="button" class="mj-settings-tabs__nav-btn" id="mj-tab-button-messaging" data-tab-target="messaging" role="tab" aria-controls="mj-tab-messaging" aria-selected="false">🔔 Notifications &amp; envois</button>
                    <button type="button" class="mj-settings-tabs__nav-btn" id="mj-tab-button-social-publish" data-tab-target="social-publish" role="tab" aria-controls="mj-tab-social-publish" aria-selected="false">📢 Publier sur les réseaux</button>
                ...
                <div class="mj-settings-tabs__panels">
                        ...
                        <div style="background: #f9f9f9; padding: 20px; margin: 20px 0; border-radius: 5px; border-left: 4px solid #0073aa;">
                            ...
                            <div style="display:flex; flex-wrap:wrap; gap:20px; margin-top:20px;">
                                <div style="flex:1 1 280px; border:1px solid #e2e8f0; background:#fff; padding:15px; border-radius:6px;">
                                    ...
                                    <p>
                                        <label><strong>Clé secréte (sk_live_...)</strong></label><br>
                                ...
                                <div style="flex:1 1 280px; border:1px solid #e2e8f0; background:#fff; padding:15px; border-radius:6px;">
                                    ...
                                    <p>
                                        <label><strong>Clé secréte test (sk_test_...)</strong></label><br>
                            ...
                            <div style="margin-top:15px;">
                                ...
                                <p style="margin:0; color:<?php echo $is_test_configured ? '#2f855a' : '#6b7280'; ?>;">TEST : <?php echo $is_test_configured ? '✅ Clés configurées' : '⚠️ Clés non configurées'; ?></p>
                            </div>
                            <div style="margin-top:16px; display:flex; flex-wrap:wrap; gap:20px;">
                                <div style="flex:1 1 260px;">
                                    <label for="mj-stripe-success-page" style="font-weight:600;">Page de redirection aprés paiement</label>
                                    <?php
                                    wp_dropdown_pages(array(
                                        'name' => 'mj_stripe_success_page',
                                        'id' => 'mj-stripe-success-page',
                                        'show_option_none' => 'é Sélectionnez une page é',
                                        'option_none_value' => '0',
                    ...
                    <div id="mj-tab-nextcloud" class="mj-settings-tabs__panel" data-tab="nextcloud" role="tabpanel" aria-labelledby="mj-tab-button-nextcloud" aria-hidden="true">
                        <div style="background:#f1f5f9; padding:20px; margin:20px 0; border-radius:8px; border-left:4px solid #16a34a;">
                            <div style="padding:16px; background:#ffffff; border:1px solid #e2e8f0; border-radius:8px;">
                                ...
                                <p style="margin-top:0; color:#475569; font-size:13px;">Le plugin utilise un <strong>compte de service Nextcloud</strong> pour lister/créer les documents et créer les comptes membres. Ce compte doit se connecter avec un <strong>mot de passe d'application</strong> (pas le mot de passe principal du compte).</p>

                                <?php if ($nc_is_ready) : ?>
                                    <p style="margin:0 0 12px 0; color:#15803d; font-weight:600;">✅ Connexion Nextcloud opérationnelle (URL + utilisateur + app password renseignés).</p>
                                <?php elseif ($nc_url_option !== '') : ?>
                                    <p style="margin:0 0 12px 0; color:#b91c1c; font-weight:600;">Configuration Nextcloud incomplète. Champs manquants : <?php echo esc_html(implode(', ', $nc_missing_fields)); ?>.</p>
                                <?php else : ?>
                                ...
                                <ol style="margin:0 0 16px 18px; color:#475569; font-size:13px;">
                                    <li>Dans Nextcloud, créez un utilisateur dédié (ex: <code>wp_mj_service</code>) avec les droits nécessaires.</li>
                                    <li>Connectez-vous avec cet utilisateur puis créez un <strong>mot de passe d'application</strong> : Paramètres → Sécurité → Mots de passe d'application.</li>
                                    <li>Renseignez ci-dessous : URL de base Nextcloud, utilisateur de service, mot de passe d'application.</li>
                                    <li>Optionnel : définissez les groupes à assigner lors de la création de comptes membres.</li>
                                ...
                                <p style="margin:0 0 12px 0; color:#64748b; font-size:12px;">Note : l'app Nextcloud Office (Collabora/OnlyOffice) est nécessaire uniquement pour l'édition en ligne des fichiers Office, pas pour la navigation de base.</p>
                                ...
                                <div style="display:flex; flex-wrap:wrap; gap:16px;">
                                    ...
                                    <div style="flex:1 1 200px;">
                                        ...
                                        <small style="color:#64748b; display:block; margin-top:4px;">Compte technique utilisé par le plugin pour l'API Nextcloud.</small>
                                    </div>
                                    <div style="flex:1 1 200px;">
                                ...
                                <div style="margin-top:12px;">
                                    ...
                                    <small style="color:#64748b; display:block; margin-top:4px;">Groupes attribués automatiquement lors de la création d'un compte membre Nextcloud (séparateurs acceptés : virgule, point-virgule, retour ligne).</small>
                    ...
                    <div id="mj-tab-account" class="mj-settings-tabs__panel" data-tab="account" role="tabpanel" aria-labelledby="mj-tab-button-account" aria-hidden="true">
                        ...
                        <p>
                            ...
                            <small style="color:#666; display:block; margin-top:4px;">Montant par défaut utilisé pour les paiements en ligne (formaté: 2.00).</small>
                        </p>
                        <p>
                            ...
                            <small style="color:#666; display:block; margin-top:4px;">Montant utilisé pour le message "Remets [montant_cotisation]" lorsque l’on remet la cotisation à un animateur (formaté: 2.00). Laissez vide pour reprendre le montant en ligne.</small>
                        </p>
                        <p>
                            <label for="mj-registration-regulation-page">Page du réglement d'ordre intérieur</label><br>
                            <?php
                            wp_dropdown_pages(array(
                            ...
                            ?>
                            <small style="color:#666; display:block; margin-top:4px;">Cette page sera proposée par défaut lors des inscriptions publiques et dans les widgets nécessitant la consultation du réglement.</small>
                        </p>
                        <p>
                        ...
                        <div style="background:#eff6ff; border-left:4px solid #2563eb; padding:18px 20px; border-radius:10px; margin-top:24px; margin-bottom:18px;">
                            ...
                            <p style="margin:0; color:#475569;">
                                <?php esc_html_e('Cette signature est utilisée automatiquement pour les messages envoyés par un membre lorsqu’aucune signature personnelle n’est définie dans sa fiche employé.', 'mj-member'); ?>
                            </p>
                        </div>

                        <div style="margin-bottom:18px;">
                            <label for="mj_contact_default_signature_editor"><strong><?php esc_html_e('Signature par défaut', 'mj-member'); ?></strong></label>
                            <?php
                            wp_editor(
                        ...
                        <div style="padding:20px; background:#f9fafb; border:1px solid #e5e7eb; border-radius:8px;">
                            ...
                            <div style="margin-bottom:20px; padding:16px; background:#fffbf0; border:1px solid #fcd34d; border-radius:6px;">
                                ...
                                <small style="color:#666; display:block; margin-top:8px;">
                                    ℹ️ Une nouvelle section sera ajoutée à la fin de la liste. Vous pourrez la réorganiser avec les autres en glissant.
                                </small>
                            </div>
                                    ...
                                    <div class="mj-account-link-details-grid">
                                        ...
                                        <div class="mj-account-link-field">
                                            ...
                                            <select id="<?php echo esc_attr($field_prefix . '-visibility'); ?>" name="mj_account_links[<?php echo esc_attr($link_key); ?>][visibility]">
                                                ...
                                                <option value="benevole" <?php selected($current_visibility, 'benevole'); ?>>🤝 Bénévoles</option>
                                        ...
                                        <?php if (!$is_section_header) : ?>
                                            <div class="mj-account-link-field">
                                                ...
                                                wp_dropdown_pages(array(
                                                    ...
                                                    'show_option_none' => 'é Dynamique é',
                                                    'option_none_value' => '0',
                    ...
                    <div id="mj-tab-social-publish" class="mj-settings-tabs__panel" data-tab="social-publish" role="tabpanel" aria-labelledby="mj-tab-button-social-publish" aria-hidden="true">
                        <div style="background:#f8fafc; border-left:4px solid #2563eb; padding:18px 20px; border-radius:10px; margin-bottom:24px;">
                            <h2 style="margin:0 0 8px 0;">📢 Publier sur les réseaux</h2>
                            <p style="margin:0; color:#475569;">
                                <?php esc_html_e('Publication des événements via un webhook n8n. Les animateurs peuvent envoyer un événement directement depuis le widget Gestionnaire.', 'mj-member'); ?>
                            </p>
                        </div>

                        <div style="background:#fff7ed; border-left:4px solid #f97316; padding:16px 18px; border-radius:8px; margin-bottom:20px;">
                            <h3 style="margin:0 0 12px 0; font-size:16px;">⚡ Mode n8n (recommandé)</h3>
                            <p style="margin:0 0 12px 0; color:#7c2d12;">
                                <?php esc_html_e('Activez ce mode pour déléguer la publication à un workflow n8n. Le plugin envoie les données de l’événement à un webhook sécurisé.', 'mj-member'); ?>
                            </p>
                            ...
                            <p style="margin-bottom:12px;">
                                ...
                                <small style="color:#9a3412; display:block; margin-top:4px;">
                                    <?php esc_html_e('Utilisez l’URL du nœud Webhook (production URL recommandée).', 'mj-member'); ?>
                                </small>
                            </p>
                            <p style="margin-bottom:0;">
                                <label for="mj-social-n8n-secret"><strong><?php esc_html_e('Secret partagé (signature HMAC)', 'mj-member'); ?></strong></label><br>
                                ...
                                <small style="color:#9a3412; display:block; margin-top:4px;">
                                    <?php esc_html_e('Le même secret doit être configuré dans n8n pour vérifier la signature du plugin.', 'mj-member'); ?>
                                </small>
                            </p>
                        </div>

                        <details style="margin-bottom:20px; background:#ffffff; border:1px solid #dbe3ef; border-radius:8px; padding:12px 14px;">
                            <summary style="cursor:pointer; font-weight:600; color:#1e293b;"><?php esc_html_e('📖 Guide complet - Facebook, Instagram & WhatsApp', 'mj-member'); ?></summary>
                                ...
                                <?php if ($social_publish_guide_html !== '') : ?>
                                    ...
                                    <p style="margin:10px 0 0 0; padding-top:10px; border-top:1px solid #dbe3ef;">
                                        <button type="button" id="mj-copy-n8n-code" class="button button-primary" style="background:#3b82f6; border-color:#3b82f6; color:#fff; margin-right:8px;">
                                            📋 <?php esc_html_e('Copier le code n8n', 'mj-member'); ?>
                                        </button>
                                        <small style="color:#64748b;"><?php esc_html_e('Cliquez pour copier le JSON du workflow dans le presse-papiers.', 'mj-member'); ?></small>
                                        <span id="mj-copy-feedback" style="display:none; margin-left:8px; color:#16a34a; font-weight:600;">✓ <?php esc_html_e('Copié !', 'mj-member'); ?></span>
                                    </p>
                                <?php else : ?>
                    ...
                    <div id="mj-tab-ai" class="mj-settings-tabs__panel" data-tab="ai" role="tabpanel" aria-labelledby="mj-tab-button-ai" aria-hidden="true">
                        ...
                        <div style="margin-top:24px; padding:16px; border:1px dashed #cbd5f5; border-radius:8px; background:#fff; color:#334155;">
                            ...
                            <ul style="margin:0 0 0 18px; padding:0; list-style:disc; color:#475569;">
                                ...
                                <li><?php esc_html_e('Supprimez réguliérement les fichiers temporaires si vous n’activez pas la suppression automatique côté serveur.', 'mj-member'); ?></li>
                            </ul>
                        </div>
                        ...
                        <div style="background:#f8fafc; border-left:4px solid #7c3aed; padding:18px 20px; border-radius:10px; margin-top:32px; margin-bottom:24px;">
                            <h2 style="margin:0 0 8px 0;">🤖 Génération de texte IA</h2>
                            <p style="margin:0; color:#475569;">
                                <?php esc_html_e("Personnalisez les instructions système envoyées à OpenAI pour la génération de descriptions d'événements, de documents d'inscription et de messages SMS. Laissez vide pour utiliser le prompt par défaut.", "mj-member"); ?>
                            </p>
                        </div>
                        ...
                        <p style="margin-bottom:18px;">
                            ...
                            <small style="color:#6b7280; display:block; margin-top:4px;">
                                <?php esc_html_e("Instruction système pour la génération de la description d'un événement depuis le gestionnaire.", "mj-member"); ?>
                            </small>
                        </p>

                        <p style="margin-bottom:18px;">
                            <label for="mj-ai-social-description-prompt"><strong><?php esc_html_e("Prompt – Description réseau social", "mj-member"); ?></strong></label><br>
                            <textarea name="mj_ai_social_description_prompt" id="mj-ai-social-description-prompt" rows="4" class="large-text" placeholder="<?php echo esc_attr__('Laissez vide pour utiliser le prompt par défaut.', 'mj-member'); ?>"><?php echo esc_textarea($ai_social_description_prompt_option); ?></textarea>
                            <small style="color:#6b7280; display:block; margin-top:4px;">
                                <?php esc_html_e("Instruction système pour la génération du texte à partager dans l'onglet Publier.", "mj-member"); ?>
                            </small>
                        </p>
                        ...
                        <p style="margin-bottom:18px;">
                            <label for="mj-ai-sms-prompt"><strong><?php esc_html_e("Prompt – Message SMS animateur", "mj-member"); ?></strong></label><br>
                            <textarea name="mj_ai_sms_prompt" id="mj-ai-sms-prompt" rows="4" class="large-text" placeholder="<?php echo esc_attr__('Laissez vide pour utiliser le prompt par défaut.', 'mj-member'); ?>"><?php echo esc_textarea($ai_sms_prompt_option); ?></textarea>
                            <small style="color:#6b7280; display:block; margin-top:4px;">
                                <?php esc_html_e("Instruction système pour la génération d'un message depuis le tableau de bord animateur.", "mj-member"); ?>
                            </small>
                        </p>
                    ...
                    <div id="mj-tab-webpush" class="mj-settings-tabs__panel" data-tab="webpush" role="tabpanel" aria-labelledby="mj-tab-button-webpush" aria-hidden="true">
                        ...
                        (function(){
                            ...
                            // Afficher l'avertissement si des clés existent déjé
