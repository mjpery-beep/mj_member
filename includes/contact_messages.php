...
if (!function_exists('mj_member_get_contact_recipient_options')) {
    ...
    function mj_member_get_contact_recipient_options() {
        ...
        if (class_exists('MjMembers')) {
            ...
            $coordinateurs = MjMembers::getAll(0, 0, 'last_name', 'ASC', '', array('role' => MjRoles::COORDINATEUR, 'status' => MjMembers::STATUS_ACTIVE));
            ...
            $animateurs = MjMembers::getAll(0, 0, 'last_name', 'ASC', '', array('role' => MjRoles::ANIMATEUR, 'status' => MjMembers::STATUS_ACTIVE));
