 ...
 */
add_action('wp_ajax_mj_header_archive_link_notifications', 'mj_header_archive_link_notifications_handler');

function mj_header_archive_link_notifications_handler() {
    check_ajax_referer('mj-notification-bell', 'nonce');

    $member_id = isset($_POST['member_id']) ? absint($_POST['member_id']) : 0;
    if ($member_id <= 0 || !mj_header_user_owns_member($member_id)) {
 ...
 */
function mj_header_user_owns_member(int $member_id): bool {
