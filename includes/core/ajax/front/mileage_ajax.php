...
final class MileageController implements AjaxHandlerInterface
{
    public function registerHooks(): void
    {
        add_action('wp_ajax_mj_mileage_create', [$this, 'mileageCreate']);
        add_action('wp_ajax_mj_mileage_update', [$this, 'mileageUpdate']);
        add_action('wp_ajax_mj_mileage_update_status', [$this, 'mileageUpdateStatus']);
        add_action('wp_ajax_mj_mileage_delete', [$this, 'mileageDelete']);
    }
    ...
    public function mileageCreate(): void
    {
    ...
    public function mileageUpdate(): void
    {
        if (!isset($_POST['nonce']) || !wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['nonce'])), 'mj-mileage')) {
            wp_send_json_error(array('message' => __('Sécurité échouée.', 'mj-member')), 403);
        }
    ...
    public function mileageUpdateStatus(): void
    {
        if (!isset($_POST['nonce']) || !wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['nonce'])), 'mj-mileage')) {
            wp_send_json_error(array('message' => __('Sécurité échouée.', 'mj-member')), 403);
        }
    ...
    public function mileageDelete(): void
    {
        if (!isset($_POST['nonce']) || !wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['nonce'])), 'mj-mileage')) {
            wp_send_json_error(array('message' => __('Sécurité échouée.', 'mj-member')), 403);
        }
