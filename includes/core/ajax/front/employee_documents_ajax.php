...
final class EmployeeDocumentsController implements AjaxHandlerInterface
{
    /* ------------------------------------------------------------------ *
     * Registration                                                        *
     * ------------------------------------------------------------------ */
    ...
    {
        add_action('wp_ajax_mj_empdocs_get_my_documents', [$this, 'getMyDocuments']);
        add_action('wp_ajax_mj_empdocs_get_all_documents', [$this, 'getAllDocuments']);
        add_action('wp_ajax_mj_empdocs_upload', [$this, 'upload']);
        add_action('wp_ajax_mj_empdocs_delete', [$this, 'delete']);
        add_action('wp_ajax_mj_empdocs_download', [$this, 'download']);
    }
    ...
    public function getMyDocuments(): void
    {
        $ctx = $this->verify();
        if (!$ctx) return;
        ...
        wp_send_json_success(array(
            'documents' => array_values(array_map([$this, 'formatDoc'], $docs)),
        ));
    }
