...
add_action('wp_ajax_mj_member_photo_timeline_chunk', 'mj_member_photo_timeline_chunk_handler');
add_action('wp_ajax_nopriv_mj_member_photo_timeline_chunk', 'mj_member_photo_timeline_chunk_handler');

function mj_member_photo_timeline_chunk_handler(): void
{
