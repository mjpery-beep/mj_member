...
final class TestimonialsController implements AjaxHandlerInterface
{
    ...
    {
        add_action('wp_ajax_mj_admin_testimonial_approve', [$this, 'adminTestimonialApprove']);
        add_action('wp_ajax_mj_admin_testimonial_reject', [$this, 'adminTestimonialReject']);
        add_action('wp_ajax_mj_admin_testimonial_delete', [$this, 'adminTestimonialDelete']);
        add_action('wp_ajax_mj_admin_testimonial_update', [$this, 'adminTestimonialUpdate']);
        add_action('wp_ajax_mj_admin_testimonial_get_for_member', [$this, 'adminTestimonialGetForMember']);
        add_action('wp_ajax_mj_admin_testimonial_update_content', [$this, 'adminTestimonialUpdateContent']);
        add_action('wp_ajax_mj_admin_testimonial_toggle_featured', [$this, 'adminTestimonialToggleFeatured']);
    }

    /**
     * AJAX: Approve a testimonial.
     */
    public function adminTestimonialApprove() {
     ...
     */
    public function adminTestimonialReject() {
        check_ajax_referer('mj_admin_testimonial', '_wpnonce');
     ...
     */
    public function adminTestimonialDelete() {
        check_ajax_referer('mj_admin_testimonial', '_wpnonce');
     ...
     */
    public function adminTestimonialUpdate() {
        check_ajax_referer('mj_admin_testimonial', '_wpnonce');
     ...
     */
    public function adminTestimonialGetForMember() {
     ...
     */
    public function adminTestimonialUpdateContent() {
        check_ajax_referer('mj_admin_testimonial', '_wpnonce');
     ...
     */
    public function adminTestimonialToggleFeatured() {
        check_ajax_referer('mj_admin_testimonial', '_wpnonce');
