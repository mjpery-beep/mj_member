...
final class DocumentsController implements AjaxHandlerInterface
{
    public function registerHooks(): void
    {
        add_action('wp_ajax_mj_documents_get_nc_member_creds', [$this, 'documentsGetNcMemberCreds']);
    }
     ...
     */
    public function documentsGetNcMemberCreds(): void
    {
        // Capability check
