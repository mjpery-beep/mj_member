...
final class MembersController implements AjaxHandlerInterface
{
    public function registerHooks(): void
    {
        add_action('wp_ajax_mj_inline_edit_member', [$this, 'inlineEditMember']);
        add_action('wp_ajax_mj_link_member_user', [$this, 'linkMemberUser']);
        add_action('wp_ajax_mj_upload_member_photo', [$this, 'uploadMemberPhoto']);
    }

    public function linkMemberUser(): void
    {
    ...
    public function inlineEditMember(): void
    {
