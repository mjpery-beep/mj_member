        ...
        if (is_string($hook) && strpos($hook, 'mj_send_emails') !== false) {
            ...
            wp_localize_script('mj-member-admin-send-emails', 'mjSendEmails', array(
                ...
                'i18n' => array(
                    ...
                    'skippedNoEmail' => __('Aucun canal de communication valide pour ce membre.', 'mj-member'),
                    'summary' => __('Récapitulatif : %1$s envoyé(s), %2$s échec(s), %3$s ignoré(s).', 'mj-member'),
                    'finished' => __('Envoi terminé.', 'mj-member'),
                    'skippedTitle' => __('Destinataires ignorés :', 'mj-member'),
    ...
    public static function registerFrontAssets(): void
    {
        ...
        wp_localize_script('mj-member-contact-messages', 'mjMemberContactMessages', array(
            'i18n' => array(
                ...
                'linkPrompt' => __('Entrez l’URL du lien :', 'mj-member'),
            ),
        ));
        ...
        self::registerScript('mj-member-regmgr-members', 'js/registration-manager/members.js', array('mj-member-regmgr-registrations', 'mj-member-regmgr-modals', 'mj-member-regmgr-document-templates'));
        self::registerScript('mj-member-regmgr-event-editor', 'js/registration-manager/event-editor.js', array('mj-member-regmgr-hooks', 'mj-member-regmgr-emoji-picker', 'mj-member-regmgr-modals'));
        ...
        self::registerScript('mj-member-regmgr-document-templates', 'js/registration-manager/document-templates.js', array('mj-member-regmgr-hooks', 'mj-member-regmgr-modals'));
        ...
        self::registerScript('mj-member-regmgr-app', 'js/registration-manager/app.js', array(
            ...
            'mj-member-regmgr-document-templates',
